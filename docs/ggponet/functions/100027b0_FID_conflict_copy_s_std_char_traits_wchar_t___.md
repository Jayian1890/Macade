# 100027b0 `FID_conflict:copy_s<std::char_traits<wchar_t>_>`
...
| --- | --- | --- | --- | --- |
| `100027c3` | `100010c0` | `UNCONDITIONAL_CALL` | FID_conflict:_Move_s | `100010c0` |

## Callers

| From | Function |
| --- | --- |
| `10002631` | std::_Traits_helper::copy_s<std::char_traits<char>_> |
...
| --- | --- | --- |
| `100027b0` | `55` | `PUSH EBP` |
| `100027b1` | `8b ec` | `MOV EBP,ESP` |
| `100027b3` | `8b 45 14` | `MOV EAX,dword ptr [EBP + 0x14]` |
| `100027b6` | `50` | `PUSH EAX` |
| `100027b7` | `8b 4d 10` | `MOV ECX,dword ptr [EBP + 0x10]` |
| `100027ba` | `51` | `PUSH ECX` |
| `100027bb` | `8b 55 0c` | `MOV EDX,dword ptr [EBP + 0xc]` |
| `100027be` | `52` | `PUSH EDX` |
| `100027bf` | `8b 45 08` | `MOV EAX,dword ptr [EBP + 0x8]` |
| `100027c2` | `50` | `PUSH EAX` |
| `100027c3` | `e8 f8 e8 ff ff` | `CALL 0x100010c0` |
