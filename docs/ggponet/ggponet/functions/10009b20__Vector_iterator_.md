...
| --- | --- | --- | --- | --- |
| `10009b32` | `10009cb0` | `UNCONDITIONAL_CALL` | FUN_10009cb0 | `10009cb0` |

## Callers

| From | Function |
| --- | --- |
| `10009155` | FUN_10009140 |
| `10009715` | FUN_10009700 |
...
| --- | --- | --- |
| `10009b20` | `55` | `PUSH EBP` |
| `10009b21` | `8b ec` | `MOV EBP,ESP` |
| `10009b23` | `51` | `PUSH ECX` |
| `10009b24` | `89 4d fc` | `MOV dword ptr [EBP + -0x4],ECX` |
| `10009b27` | `8b 45 0c` | `MOV EAX,dword ptr [EBP + 0xc]` |
| `10009b2a` | `50` | `PUSH EAX` |
| `10009b2b` | `8b 4d 08` | `MOV ECX,dword ptr [EBP + 0x8]` |
| `10009b2e` | `51` | `PUSH ECX` |
| `10009b2f` | `8b 4d fc` | `MOV ECX,dword ptr [EBP + -0x4]` |
| `10009b32` | `e8 79 01 00 00` | `CALL 0x10009cb0` |
| `10009b37` | `8b 45 fc` | `MOV EAX,dword ptr [EBP + -0x4]` |
| `10009b3a` | `8b e5` | `MOV ESP,EBP` |
| `10009b3c` | `5d` | `POP EBP` |
| `10009b3d` | `c2 08 00` | `RET 0x8` |
